...
/* renamed from: com.com.androidrr.s1 */
/* loaded from: classes.dex */
public class ServiceC0262s1 extends Service {
    static ServiceC0262s1 mostCurrent;
    ...
    public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
            BA BA = new BA(this, (BALayout) null, (BA) null, "com.com.androidrr", "com.com.androidrr.s1");
            processBA = BA;
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
            BA BA2 = processBA;
            BA2.raiseEvent2(null, true, "CREATE", true, "com.com.androidrr.s1", BA2, this._service, Float.valueOf(Common.Density));
        }
    ...
    public int onStartCommand(final Intent intent, int i, int i2) {
        if (!ServiceHelper.StarterHelper.onStartCommand(processBA, new Runnable() { // from class: com.com.androidrr.s1.1
            @Override // java.lang.Runnable
            public void run() {
                ServiceC0262s1.this.handleStart(intent);
            }
        })) {
            ServiceHelper.StarterHelper.addWaitForLayout(new Runnable() { // from class: com.com.androidrr.s1.2
                @Override // java.lang.Runnable
                public void run() {
                    ServiceC0262s1.processBA.setActivityPaused(false);
                    BA.LogInfo("** Service (s1) Create **");
                    ServiceC0262s1.processBA.raiseEvent(null, "service_create", new Object[0]);
                    ServiceC0262s1.this.handleStart(intent);
    ...
    /* renamed from: com.com.androidrr.s1$_message */
    ...
    public static String _service_start(IntentWrapper intentWrapper) throws Exception {
        intentWrapper.getAction().equals("android.provider.Telephony.SMS_RECEIVED");
